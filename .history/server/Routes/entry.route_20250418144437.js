...
import { getEntryDetailsById } from "../Controllers/Entry/getEntryDetailsById.js";
import { getSubEntryDetails } from "../Controllers/SubEntry/getSubEntryDetails.js";
...
// Get all entries of a project
router.get("/:projectId/:entryId", getEntryDetailsById);
...
router.post("/createSubEntry/:entryId", createSubEntryToEntry);

// Update a specific sub-entry inside an entry
router.put("/:entryId/:subEntryId", updateSubEntryToEntry);

// get subEntryDetails
router.get("getSubEntryDetails/:entryid/:subEntryId", getSubEntryDetails);
