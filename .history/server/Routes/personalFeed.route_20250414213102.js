...
router.get("/getAllPersonalFeeds", getAllPersonalFeeds);

// Update a personal feed entry
router.put("/:feedId/updatePersonalFeed", updatePersonalFeed);

// Delete a personal feed entry
router.delete("/:feedId/deletePersonalFeed", deletePersonalFeed);
