...
const AddProjectModal = ({ showModal, handleClose, handleAddProject }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black opacity-40 backdrop-blur-sm flex justify-center items-center z-50">
            <div className="bg-gray rounded-lg shadow-lg w-96 p-6 overflow-y-auto max-h-[80vh]">
