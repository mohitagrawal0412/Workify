...
import { FaDotCircle, FaClock, FaPaperclip, FaTags, FaBookOpen } from "react-icons/fa";

const EntryDetails = () => {
    const handleEntryClick = () => {
        navigate("/subEntryDetails");
    };
                            ...
                            >
                                ...
                                >
                                    <div className="flex justify-between items-center mb-2">
                                        <h3 className="text-lg font-semibold text-indigo-600">{sub.workTitle}</h3>
                                    ...
                                    {sub.whatLearned && (
                                        <div className="text-sm text-gray-700 mb-2">
                                            ...
                                            <span className="font-medium">Learned:</span> {sub.whatLearned}
                                        </div>
                                    )}
                                    ...
                                    {sub.tags?.length > 0 && (
                                        <div className="text-sm text-gray-700 mb-2 flex flex-wrap gap-2">
                                            ...
                                            {sub.tags.map((tag, i) => (
                                                <span key={i} className="bg-indigo-100 text-indigo-700 px-2 py-0.5 rounded-full text-xs">
                                                    #{tag}
                                                </span>
                                            ))}
                                        </div>
