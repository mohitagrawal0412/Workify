        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-200 py-10 px-6 relative">
            <div className="flex justify-between items-center mb-10">
                ...
                <button
                    ...
                    className="flex items-center gap-2 bg-indigo-600 text-white px-4 py-2 rounded-full shadow-lg hover:bg-indigo-700 transition-all duration-200"
                >
                    <FaPlus /> Add Project
                </button>
            </div>
            ...
            {isModalOpen && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 transition-all">
                    <div className="bg-white rounded-xl shadow-2xl p-8 w-full max-w-md relative transform transition-all duration-500 ease-in-out">
                        <h2 className="text-2xl font-semibold mb-6 text-center text-gray-700">Add New Project</h2>
                        ...
                        <input
                            ...
                            className="w-full mb-4 px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 transition duration-300"
                        />
                        <textarea
                            name="description"
                        ...
                        <div className="flex justify-end gap-4">
                            <button
                                ...
                                className="px-6 py-3 bg-gray-300 text-gray-800 rounded-xl hover:bg-gray-400 transition duration-200"
                            >
                                Cancel
                            </button>
                            <button
