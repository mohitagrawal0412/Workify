...
const ProjectDetails = () => {
    ...
    const handleViewFullProject = () => {
        // Logic to navigate to the full project details page
        navigate("/projectOverview"); // Adjust according to your route structure
    };

    const handleAddNewTask = () => {
        // Navigate to the page to add a new task
        navigate("/addTask"); // Adjust according to your route structure
    };

    const handleViewTeamMembers = () => {
        // Navigate to the team members page
        navigate("/teamMembers"); // Adjust according to your route structure
    };
