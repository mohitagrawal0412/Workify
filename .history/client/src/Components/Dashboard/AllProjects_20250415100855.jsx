                ...
                {dummyProjects.map((project) => (
                    ...
                    >
                        ...
                        <div className="bg-gray-50 px-5 py-3 rounded-b-2xl text-right">
                            {/* View Details Button */}
                            {/* <button
                                onClick={() => handleViewDetails(project._id)} // Handle click with navigation
                                className="text-sm text-indigo-600 hover:underline font-medium"
                            >
                                View Details →
                            </button> */}
                            <button className="text-sm text-indigo-600 hover:underline font-medium"> <Link to="/projectDetails" className="hover:text-purple-600">View Details</Link></button>
                        </div>
                    </div>
                ))}
            </div>
