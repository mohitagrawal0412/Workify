...
const AllProjects = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-200 py-10 px-6 relative">
            ...
            {/* Add Project Modal */}
            {isModalOpen && (
                <div className="fixed inset-0 flex justify-center items-center z-50 back">
                    <div className="absolute inset-0 bg-black bg-opacity-50 backdrop-blur-sm"></div> {/* Blurred background */}
                    <div className="bg-white rounded-xl shadow-xl p-6 w-full max-w-md relative z-10">
                        <h2 className="text-2xl font-semibold mb-4 text-center text-gray-800">Add New Project</h2>
