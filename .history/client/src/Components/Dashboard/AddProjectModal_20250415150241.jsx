...
const AddProjectModal = ({ showModal, handleClose, handleAddProject }) => {
    ...
    return (
        <div className="fixed bg-black bg-opacity-50inset-0 z-50 flex justify-center items-center">
            {/* Overlay */}
            <div
            ...
            {/* Modal content */}
            <div className="bg-white rounded-lg shadow-lg w-96 p-6 z-60 relative overflow-y-auto max-h-[80vh]">
