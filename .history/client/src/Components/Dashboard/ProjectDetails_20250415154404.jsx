                        ...
                        {project.entries.map((entry, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {/* Entry Card */}
                                    <div className={`w-5/12 p-5 bg-white/70 backdrop-blur-md border border-gray-200 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer ${isLeft ? "mr-auto" : "ml-auto"}`}>
