        ...
        <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 p-6">
            ...
            {modalImage && (
                <div
                    ...
                    onClick={closeModal}
                >
                    <div className="relative bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 p-6 rounded-lg max-w-lg">
                        <button
                            onClick={closeModal}
            ...
            {showEditModal && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 p-6 rounded-lg max-w-lg">
