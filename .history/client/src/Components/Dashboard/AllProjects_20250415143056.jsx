...
import { Modal, Button, Form } from "react-bootstrap"; // Import Bootstrap Modal and components
...
const AllProjects = () => {
    ...
    const handleSubmit = (e) => {
        ...
        // Handle project submission (you can send this data to the backend or store locally)
        setShowModal(false);
    };
            ...
            <Modal show={showModal} onHide={handleCloseModal}>
                ...
                <Modal.Body>
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Form.Group controlId="personalFeedback">
