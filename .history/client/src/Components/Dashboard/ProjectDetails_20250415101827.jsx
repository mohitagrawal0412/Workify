    ...
    return (
        <div className="min-h-screen flex">
            ...
            <div className="w-2/3 p-6 bg-gray-100 relative">
                ...
                {/* Timeline Line */}
                <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-px h-full bg-gray-300"></div>
                ...
                <div className="space-y-8">
                    {project.entries.map((entry, index) => (
                        ...
                        >
                            {/* Entry Block */}
                            <div
                                className="p-6 bg-white shadow-lg rounded-lg cursor-pointer hover:bg-gray-50 w-80"
                            >
                            ...
                            {/* Timeline Marker */}
                            <div className="w-6 h-6 bg-blue-500 rounded-full absolute left-1/2 transform -translate-x-1/2 top-1/2 -translate-y-1/2"></div>
                        </div>
                    ))}
                </div>
            </div>
