...
// Context
import { useProjectContext } from "../Pages/ProjectContext.jsx";
...
const AllProjects = () => {
    ...
    const handleAddProject = async (e) => {
        e.preventDefault();
        // Send POST request here if needed, or update context
        console.log("New Project:", newProject);
        setShowAddModal(false);
        // await axios.post("/api/projects", newProject); // If required
        await refreshProjects(); // Refresh data after adding
    };
