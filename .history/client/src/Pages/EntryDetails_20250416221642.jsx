...
const EntryDetails = () => {
    ...
    useEffect(() => {
        // Construct the API endpoint with projectId and entryId
        axios
            .get(`https://your-backend-api.com/entries/${projectId}/${entryId}`)
            .then(response => {
                setEntry(response.data);  // Set the fetched entry data
                setEditedEntry(response.data);  // Initialize editedEntry with fetched data
            })
            .catch(error => {
                console.error("Error fetching entry data:", error);
            });
    }, [projectId, entryId]); // Rerun effect if projectId or entryId changes
    ...
    const handleSaveEdit = () => {
        ...
        axios.put(`https://your-backend-api.com/entry/${entry.id}`, editedEntry)
            .then(response => {
    ...
    const handleDeleteEntry = () => {
        ...
        axios.delete(`https://your-backend-api.com/entry/${entry.id}`)
            .then(() => {
