...
const EntryDetails = () => {
    ...
    const handleAddSubentry = () => {
        // Logic to navigate to the page where you can add a new subentry
        navigate("/addSubentry"); // Update the path based on your routing structure
    };

    const handleGoToAllProjects = () => {
        // Navigate back to the all projects page
        navigate("/projects"); // Update this based on your routing structure
    };
